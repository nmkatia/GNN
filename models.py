...
class GraphSage(pyg_nn.MessagePassing):
    ...
    def forward(self, x, edge_index):
        ...
        ###1 : Weighted Linear Transformation of  the input feature matrix of shape [number_nodes, number_features] into a higher-D space (matrix)
        ## of dimension [number_features, out(hidden)_nodes]
       ...
       ###2 : Message Propagation 
        ...
        out = F.relu(self.agg_lin(torch.cat([x, out], dim=1)))
        out.bias
...
class GAT(pyg_nn.MessagePassing):
    ...
    def message(self, edge_index_i, x_i, x_j, size_i):
        ...
        alpha = pyg_utils.softmax(alpha, edge_index_i, x_i.size(0))
        ############################################################################
